...
function initialiserDonnees(){
    document.querySelector("#titre").innerHTML = data.polluant;
    document.querySelector("#annee").innerHTML = data.annee;
    data.pays.forEach( ele => {
        document.querySelector("#listePays").innerHTML += ("Nom: " + ele.nom + " valeur " + ele.valeur + " %" + ele.pourcentage + " code " + ele.code + "<br>");
    })
}